    ...
    <nav class="navbar navbar-expand-lg fundoMenu">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="cadastroConsultaFuncionario.jsp">Consulta</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="cadastroProdutoFuncionario.jsp">Estoque</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="sairFuncionario.jsp">Sair</a>
                </li>
            </ul>
        </div>
    </nav>
