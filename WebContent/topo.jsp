            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="funcionarioLogar.jsp">Funcionário</a>
                        <a class="dropdown-item" href="medicoLogar.jsp">Médico</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="guiaSaude.jsp">Saúde</a>
                        <a class="dropdown-item" href="guiaDoenca.jsp">Doenças</a>
                    </div>
                </li>
                <li class="nav-item">
